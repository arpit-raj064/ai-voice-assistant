...
async def process_speech(
    ...
    if escalate:
        ...
        # Fallback if caller says nothing after gather timeout
        no_input_text = "I'm sorry, I didn't hear anything. Please call us back anytime. Goodbye!"
        response.say(no_input_text, voice=FALLBACK_VOICE, language=FALLBACK_LANG)
        response.hangup()
